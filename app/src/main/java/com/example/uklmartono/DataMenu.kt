...
import com.example.uklmartono.databinding.ActivityDataMenuBinding
...
class DataMenu : AppCompatActivity() {
    ...
    private fun initFoodRv(){
        ...
        val Adapterfood = AdapterMangan(this, foods, menuViewModel)
    ...
    private fun initBeverageRv(){
        ...
        val Adapterbeverage = AdapterOmbe(this, beverages, menuViewModel)
