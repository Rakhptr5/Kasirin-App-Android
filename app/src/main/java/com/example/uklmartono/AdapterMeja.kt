...
import com.example.uklmartono.databinding.MejaBinding
...
class AdapterMeja (private val context: Context, private val tables : ArrayList<Meja>,
    ...
    inner class ViewHolder(private val binding : MejaBinding): RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = MejaBinding.inflate(LayoutInflater.from(parent.context), parent, false)
